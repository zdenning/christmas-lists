...
public interface ListApi
{
     ...
     */
    @ApiOperation(value = "", nickname = "listGet", notes = "Retrieves the list for specified user.", response = ChristmasList.class, tags={  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Successful Operation", response = ChristmasList.class) })
    @RequestMapping(value = "/list",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<ChristmasList> listGet(
